...
namespace Services
{
    ...
    /// </summary>
    public class LectureInstanceFix4
    {
        ...
        public LectureInstanceFix4(IObserverConsole observer) 
            : this(observer, 10, 2, 12, DateTime.Now.AddDays(10), AcademicLevel.None, AcademicLevel.Bachelor)
        { }

        public LectureInstanceFix4(IObserverConsole observer, int maxStudents, int maxLecturers, int maxSeats, DateTime lastTimetoRegister, AcademicLevel requiredToAttend, AcademicLevel requiredToTeach)
        {
        ...
        {
            return lecturers.Count < maxLecturers && (int)p.Level >= (int)this.academicLevelRequiredToTeach;
        }
